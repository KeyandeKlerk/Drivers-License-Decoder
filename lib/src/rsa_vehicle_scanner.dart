...
class RsaVehicleD extends StatefulWidget {
  @override
  _RsaVehicleScannerState createState() => _RsaVehicleScannerState();
}

/// The state for the [RsaIdCardScanner] widget.
class _RsaVehicleScannerState extends State<RsaVehicleD>
